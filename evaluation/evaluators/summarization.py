...
class SummarizationEvaluator:
    ...
    def replace_template_vars(self, template_str: str, sample: Dict[str, Any]) -> str:
        ...
        Args:
            template_str: template string, e.g. "answer: {sample.Question}"
            sample: sample data
            ...
            if test_input in dataset_info:
                ...
                if 'file_name' in dataset_config:
                    ...
                    if full_path.exists():
                        ...
                        logger.warning(f"⚠️ file in dataset_info does not exist: {full_path}")
                else:
...
def example_usage():
    ...
    # initialize pipeline
    pipeline = SummarizationEvaluator(
